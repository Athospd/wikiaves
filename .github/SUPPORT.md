# Getting help with wikiaves

Thanks for using wikiaves. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/wikiaves/issues) to make sure the 
